...
# data_path = "data/reframings/gossipcop_train_emotionally_triggering.pkl"
...
# file_path = "data/veracity_attributions/lun_fake_standards_neutral_sensational.pkl"   # change this
file_path = "data/news_articles/politifact_train.pkl"   # change this
...
if isinstance(data, dict):
    for k, v in data.items():
        ...
        try:
            print("Sample:", v[0])   # print first element if possible
        except:
            pass

    # ✅ NEW PART: Print classes clearly
    if "classes" in data:
