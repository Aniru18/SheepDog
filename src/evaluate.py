...
# src/evaluate_adversarial_fixed_labels.py
# import torch
...
#             _, out_labels_bi = model(input_ids, attention_mask)
#             _, preds = torch.max(out_labels_bi, dim=1)
#             all_preds.extend(preds.cpu().numpy())
#             all_labels.extend(labels.cpu().numpy())
#     return all_labels, all_preds

# def compute_metrics(y_true, y_pred):
#     precision, recall, f1, _ = score(y_true, y_pred, average='macro')
#     acc = accuracy_score(y_true, y_pred)
#     return acc, precision, recall, f1

# def load_adversarial_data(dataset_name, variant):
#     """Load adversarial variant directly from pickle using same structure as GitHub"""
#     filepath = f"data/adversarial_test/{dataset_name}_test_adv_{variant}.pkl"
#     data = pickle.load(open(filepath, 'rb'))
#     x_test = data['news']
#     y_test = data['labels']
#     return x_test, y_test

# def run_evaluation(model, tokenizer, dataset_name, max_len, batch_size):
#     # Load original test data
#     x_train, x_test, x_test_res, y_train, y_test = load_articles(dataset_name)
    
#     variants = {
#         "Original": (x_test, y_test),
#         "A": load_adversarial_data(dataset_name, "A"),
#         "B": load_adversarial_data(dataset_name, "B"),
#         "C": load_adversarial_data(dataset_name, "C"),
#         "D": load_adversarial_data(dataset_name, "D"),
#     }

#     for variant_name, (x_var, y_var) in variants.items():
#         all_acc, all_prec, all_rec, all_f1 = [], [], [], []
#         test_loader = create_eval_loader(x_var, y_var, tokenizer, max_len, batch_size)

#         # Simulate multiple evaluation splits (like GitHub log)
#         for _ in range(10):  # same 10 splits as GitHub
...
#     # Load model checkpoint (adjust filename as per your training)
#     model = RobertaClassifier(n_classes=4).to(device)
#     model.load_state_dict(torch.load(f"checkpoints/{dataset_name}_iter0.pt", map_location=device))

#     run_evaluation(model, tokenizer, dataset_name, max_len, batch_size)
#....................................................................
